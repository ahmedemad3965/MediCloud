...
<template>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="javascript:void()" @click="scrollTo('features')">FEATURES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="javascript:void()" @click="scrollTo('details')">DETAILS</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="javascript:void()" @click="scrollTo('pricing')">PRICING</a>
                    </li>
                </ul>
                <span class="nav-item">
                    <router-link class="btn-outline-sm" to="/patients/auth">LOG IN</router-link>
                </span>
            </div>
    ...
    <svg class="header-frame" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"
        viewBox="0 0 1920 310" style="fill: #0068f9;">
        <defs>
        </defs>
        <path class="cls-1"
    ...
    <div class="slider-1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <img :src="require('@/assets/images/customers.png')" alt="new-customers" style="width: 100%; height: auto; object-fit: cover;">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of slider-1 -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>No more serious medical data breaches, thanks to our cutting-edge technologies, making it 100% secure cloud for your confidential medical data</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Your data will be in sync wherever you go, between all hospitals, clinics, and labs with no more redundancy</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Easier communication between all medical providers in Egypt by providing a link for each healthcare stakeholder</p>
                        </div>
                    </div>
                    <!-- end of card -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p v-if="isPatient" class="p-heading">Benefit from our valuable features for patients that empower you to maintain a healther life and safer in case of emergencies</p>
                    <p v-else class="p-heading">Take your business strategy to the next level and automatize your marketing
                    ...
                    <ul class="nav nav-tabs" id="argoTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab"
                                aria-controls="tab-1" aria-selected="true"><i class="fas fa-list"></i>For Patients</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nav-tab-2" data-toggle="tab" href="#tab-2" role="tab"
                                aria-controls="tab-2" aria-selected="false"><i
                                    class="fas fa-envelope-open-text"></i>For Doctors</a>
                        </li>
                    </ul>
                    <!-- end of tabs links -->
                    ...
                    <div class="tab-content" id="argoTabsContent">
                        ...
                        <div class="tab-pane show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" :src="require('@/assets/images/features-1.png')"
                                            alt="alternative">
                                    </div> <!-- end of image-container -->
                                </div> <!-- end of col -->
                                <div class="col-lg-6">
                        ...
                        <div class="tab-pane show active" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" :src="require('@/assets/images/features-2.png')"
                                            alt="alternative">
                                    </div> <!-- end of image-container -->
                                </div> <!-- end of col -->
                                <div class="col-lg-6">
                        ...
                        <div class="tab-pane show active" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" :src="require('@/assets/images/features-3.png')"
                                            alt="alternative">
                                    </div> <!-- end of image-container -->
                                </div> <!-- end of col -->
                                <div class="col-lg-6">
    ...
    <div id="details" ref="details" class="basic-1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" :src="require('@/assets/images/details.png')" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                    ...
                    <div class="image-container">
                        <div class="video-wrapper">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs"
                                data-effect="fadeIn">
                                <img class="img-fluid" :src="require('@/assets/images/video-image.png')"
                                    alt="alternative">
    ...
    <!-- Pricing -->
    <div id="pricing" ref="pricing" class="cards-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" :src="require('@/assets/images/testimonial-1.jpg')"
                                            alt="alternative">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" :src="require('@/assets/images/testimonial-2.jpg')"
                                            alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" :src="require('@/assets/images/testimonial-3.jpg')"
                                            alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="image-wrapper">
                                        <img class="img-fluid" :src="require('@/assets/images/testimonial-4.jpg')"
                                            alt="alternative">
                                    </div> <!-- end of image-wrapper -->
                                    <div class="text-wrapper">
    ...
    <svg class="footer-frame" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"
        viewBox="0 0 1920 79" style="fill: #0068f9;">
        <defs>
        </defs>
        <path class="cls-2"
